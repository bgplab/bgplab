...
* You can do automated lab validation when running Arista EOS or FRRouting on the external router. Automated lab validation requires _netlab_ release 1.8.3 or higher.
