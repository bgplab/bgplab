...
Now simulate a *fat-finger* incident in the customer network. Use **sh** to execute the `start` script in your lab directory, optionally specifying the number of prefixes you want the customer to generate:
